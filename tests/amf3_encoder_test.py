...
class Amf3EncoderTestCase(unittest.TestCase):
    ...
    def testInt(self):
        tests = {
            ...
            0x35: '\x11\x04\x35',
            0x7f: '\x11\x04\x7f',
            0x80: '\x11\x04\x81\x00',
            0xd4: '\x11\x04\x81\x54',
            0x3fff: '\x11\x04\xff\x7f',
            0x4000: '\x11\x04\x81\x80\x00',
            0x1a53f: '\x11\x04\x86\xca\x3f',
            0x1fffff: '\x11\x04\xff\xff\x7f',
            0x200000: '\x11\x04\x80\xc0\x80\x00',
            -0x01: '\x11\x04\xff\xff\xff\xff',
            -0x2a: '\x11\x04\xff\xff\xff\xd6',
            0xfffffff: '\x11\x04\xbf\xff\xff\xff'
        }
    ...
    def testFloat(self):
        tests = {
            0.1: '\x11\x05\x3f\xb9\x99\x99\x99\x99\x99\x9a',
            0.123456789: '\x11\x05\x3f\xbf\x9a\xdd\x37\x39\x63\x5f'
        }
    ...
    def testLong(self):
        tests = {
            0x10000000: '\x11\x05\x41\xb0\x00\x00\x00\x00\x00\x00',
            -0x10000001: '\x11\x05\xc1\xb0\x00\x00\x01\x00\x00\x00',
            -0x10000000: '\x11\x04\xc0\x80\x80\x00'
        }
    ...
    def testUnicode(self):
        tests = {
            u'': '\x11\x06\x01',
            u'hello': '\x11\x06\x0bhello',
            u'ᚠᛇᚻ': '\x11\x06\x13\xe1\x9a\xa0\xe1\x9b\x87\xe1\x9a\xbb'
        }
    ...
    def testUnicodeRefs(self):
        ...
        result = '\x11\x09\x09\x01' # array header
    ...
    def testTupleRefs(self):
        ...
        result = '\x11\x09\x05\x01' # array header
    ...
    def testTupleAsCollection(self):
        ...
        result = '\x11\x0A\x07\x43flex.messaging.io.ArrayCollection' # Object header 
    ...
    def testArrayCollectionRef(self):
        ...
        result = '\x11\x0A\x07\x43flex.messaging.io.ArrayCollection\x09\x05\x01' # array header
    ...
    def testDict(self):
        result = '\x11\x0A\x0B\x01' # Object header
        result += '\x09spam' # key
    ...
    def testDictAsObjectProxy(self):
        result = '\x11\x0A\x07\x3Bflex.messaging.io.ObjectProxy' # Object header 
    ...
    def testDate(self):
        ...
        buf = encode.encode(test, EncoderContext(amf3=True))
        self.assertEquals('\x11\x08\x01Bp+6!\x15\x80\x00', buf)

        test = datetime.date(2003, 12, 1)
        buf = encode.encode(test, EncoderContext(amf3=True))
        self.assertEquals('\x11\x08\x01Bo%\xe2\xb2\x80\x00\x00', buf)
    ...
    def testStaticObj(self):
        ...
        result = '\x11\x0A\x13\x15alias.spam'
    ...
    def testDynamicObj(self):
        ...
        result = '\x11\x0A\x0B\x15alias.spam'
    ...
    def testStaticDynamicObj(self):
        ...
        result = '\x11\x0A\x1B\x15alias.spam' # obj header
        result += '\x09spam' # static attr definition
        result += '\x06\x09eggs' # static attrs
    ...
    def testExternalizable(self):
        custom_encoding = '\x11\x01\x02\x03\x04\x05'
        ...
        result = '\x11\x0A\x07\x15alias.spam'
